-- Insert default billing automation rules for all tenants
...
CROSS JOIN (
  VALUES 
    ...
    ('মেয়াদ উত্তীর্ণ SMS সতর্কতা', 'মেয়াদ শেষ হওয়ার ৩ দিন আগে SMS পাঠায়', 'expiry_warning', 3, 'expiry_date <= CURRENT_DATE + 3', 'send_sms', true),
    ('মেয়াদ উত্তীর্ণ Email সতর্কতা', 'মেয়াদ শেষ হওয়ার ৫ দিন আগে Email পাঠায়', 'expiry_warning', 5, 'expiry_date <= CURRENT_DATE + 5', 'send_email', false),
    ...
    ('বিল বাকি রিমাইন্ডার', 'বিল বাকি থাকলে রিমাইন্ডার SMS পাঠায়', 'due_reminder', 0, 'due_amount > 0', 'send_sms', true),
    ('অতিরিক্ত বাকি ব্লক', 'অতিরিক্ত বাকি থাকলে কানেকশন ব্লক করে', 'overdue_block', 7, 'due_amount > monthly_bill * 2', 'disable_pppoe', false),
    ...
    ('সাপ্তাহিক বিল রিমাইন্ডার', 'প্রতি সপ্তাহে বাকি বিলের রিমাইন্ডার', 'due_reminder', 7, 'due_amount > 0 AND last_reminder > 7 days', 'send_sms', false)
